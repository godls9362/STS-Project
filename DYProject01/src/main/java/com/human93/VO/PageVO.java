...
public class PageVO {   // 게시판테이블,회원테이블의 필드와는 직접관계없음.
	private int startNo; //페이지 시작 번호
	private int endNo; //끝 번호 
	private int perPageNum; //한 페이지에 출력될 게시물 갯수
	private Integer page; // jsp단에서 null로 값이 올때 에러가 발생하지 않도록 Integer사용 , 페이지 정보
	private int totalCount; //전체 게시물 수 
	private int endPage; //현재 페이지 속한 페이지 그룹
	private int startPage; //e.g 13= 11~20
	private boolean prev; //이전글
	private boolean next; //다음글
	// 검색용 변수 2개 추가
